   ...
   @section('content')
       ...
       role="tab">Open Market</a>
       <a class="list-group-item" data-bs-toggle="list" href="#id2"
       role="tab">Partner Shops</a>
       <a class="list-group-item" data-bs-toggle="list" href="#id1"
       role="tab">Game Assets</a>
       </div>
       ...
       <button class="search-btn" type="submit"><img src="img/search.png"
       alt="#"></button>
       ...
       by</span>
       <h4 class="nftmax-trendmeta__title">Yuaisn
       Kha</h4>
       </div>
       <div class="nftmax-trendmeta__img">
       <img src="img/market-author-2.png"
       alt="#">
       </div>
       </div>
       </div>
       ...
       <img src="img/marketplace-6.png" alt="#">
       </div>
       <!-- Trending Body -->
       <div
       class="trending-action__body trending-marketplace__body">
       ...
       <img src="img/marketplace-7.png" alt="#">
       </div>
       <!-- Trending Body -->
       <div
       class="trending-action__body trending-marketplace__body">
       ...
       <img src="img/marketplace-8.png" alt="#">
       </div>
       <!-- Trending Body -->
       <div
       class="trending-action__body trending-marketplace__body">
       ...
       <img src="img/marketplace-9.png" alt="#">
       </div>
       <!-- Trending Body -->
       <div
       class="trending-action__body trending-marketplace__body">
       ...
       <h4 class="nftmax-sidebar__cstatics-title">Your All Artwork
       Statistics</h4>
       ...
       <a href="#"><b
       class="nftmax-sidebar__creator-name">Jenny
       Wilson<span
       class="nftmax-sidebar__creator-link">@broklinslam_75</span></b></a>
       </div>
       <div class="nftmax-sidebar__button">
       ...
       <a href="#"><b
       class="nftmax-sidebar__creator-name">Jacob
       Jones<span
       class="nftmax-sidebar__creator-link">@broklinslam_75</span></b></a>
       </div>
       <div class="nftmax-sidebar__button">
       ...
       <a href="#"><b
       class="nftmax-sidebar__creator-name">Cody
       Fisher<span
       class="nftmax-sidebar__creator-link">@broklinslam_75</span></b></a>
       </div>
       <div class="nftmax-sidebar__button">
